...
If you are using RStudio and the **shinybrms** app crashes RStudio when starting the Stan run, then run the following R code before launching the **shinybrms** app:
```{r, eval = FALSE}
