...
The [R](https://www.R-project.org/) package [**shinybrms**](https://fweber144.github.io/shinybrms/) provides a graphical user interface (GUI) for fitting Bayesian regression models using the R package [**brms**](https://paul-buerkner.github.io/brms/) which in turn relies on [Stan](https://mc-stan.org/). More specifically, the only **brms** backend currently supported by **shinybrms** is the R package [**rstan**](https://mc-stan.org/rstan/). The **shinybrms** GUI is a [Shiny](https://shiny.rstudio.com/) app.
