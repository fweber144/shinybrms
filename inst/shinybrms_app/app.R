...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    helpText(HTML(paste0(
      ...
      code("brms::set_prior()"), ". For details concerning the specification of",
      "custom priors, see the help for ", code("brms::set_prior()"), " as well as the ",
