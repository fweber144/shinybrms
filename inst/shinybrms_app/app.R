  ...
  tabPanel(
    ...
    wellPanel(
      ...
      withMathJax(helpText(
        p("Before using the Stan results for posterior inference, it is important to check some",
          "MCMC diagnostics. These MCMC diagnostics aim at checking the convergence and",
          "efficiency of the sampling algorithm for the given model and data.",
          "The MCMC diagnostics may be divided into",
          em("HMC-specific"), "and", em("general MCMC"), "diagnostics.",
          "For details concerning all these MCMC diagnostics, see the",
