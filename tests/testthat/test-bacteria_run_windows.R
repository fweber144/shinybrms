...
test_that("Migrated shinytest test: bacteria_run_windows.R", {
  ...
  app$set_inputs(likelihood_navlist_ID = "Formula preview")
  app$expect_values(output = c("formula_view"))
  app$set_inputs(likelihood_navlist_ID = "Predictors", pred_int_build = c("week",
                                                                          "trt"), pred_int_add = "click")
  app$set_inputs(likelihood_navlist_ID = "Formula preview")
  app$set_inputs(navbar_ID = "Prior", prior_class_sel = "b", prior_text = "student_t(3, 0, 4)",
                 prior_add = "click")
  app$set_inputs(navbar_ID = "Posterior", show_advOpts = TRUE,
                 advOpts_seed = 6789, advOpts_cores = 2, advOpts_chains = 2,
  ...
  app$expect_download("stanout_download", name = file.path("..",
                                                           paste0("bacteria", "_full.rds")))
  ...
  app$expect_values(input = TRUE, output = setdiff(lapply(app$get_values(),
  ...
  if (getOption("sbtst.run_upd_extend", TRUE)) {
    ...
    app$set_inputs(likelihood_navlist_ID = "Predictors", pred_mainPL_sel = "trt")
    app$set_inputs(likelihood_navlist_ID = "Formula preview")
    app$set_inputs(navbar_ID = "Prior", prior_add = "click")
  ...
  app$set_inputs(navbar_ID = "Likelihood")
  app$set_inputs(likelihood_navlist_ID = "Predictors", pred_mainPL_sel = character(0))
  app$set_inputs(likelihood_navlist_ID = "Formula preview")
