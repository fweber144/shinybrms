...
\
Underneath the HMC diagnostics, we get a short summary of our posterior inference including some more general Markov chain Monte Carlo (MCMC) diagnostics (`Rhat`, `Bulk_ESS`, `Tail_ESS`). Here, these MCMC diagnostics are all OK (cf. [Vehtari et al. (2020)](https://doi.org/10.1214/20-BA1221) to see why):
