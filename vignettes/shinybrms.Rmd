...
The following screenshots show how to fit an example model in the **shinybrms** app.
For instructions on how to launch the **shinybrms** app, see the [starting page](../index.html).

Another example may be found in @weber_shinybrms_2022.
...
\
Here, we focus on panel "Advanced options" where we set a seed for reproducibility (and we also choose 4 cores to use parallel computation):
