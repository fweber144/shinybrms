...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/bacteria_post.png")
```
[![](screenshots/bacteria_post.png)](screenshots/bacteria_post.png)
*Fig. 10: Page "Posterior", tab "Run Stan" (top).*
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/bacteria_advOpts.png")
```
[![](screenshots/bacteria_advOpts.png)](screenshots/bacteria_advOpts.png)
*Fig. 11: Page "Posterior", tab "Run Stan", panel "Advanced options".*
