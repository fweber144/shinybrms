...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CustSummary.png")
```
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CustSummary_done.png")
```
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CondEff.png")
```
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CondEff_done.png")
```
