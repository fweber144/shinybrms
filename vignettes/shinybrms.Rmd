...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CustSummary_1.png")
```
[![](screenshots/Posterior_CustSummary_1.png)](screenshots/Posterior_CustSummary_1.png)
*Fig. 21: Page "Posterior", tab "Custom summary" (top).*

\
Here, it makes sense to calculate posterior summary quantities for the `trt`-specific `week` effects which are given by the sum of the main effect of `week` and the interaction effect for the corresponding `trt` value (except for the reference `trt` level where this interaction effect does not exist):

\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CustSummary_2.png")
```
[![](screenshots/Posterior_CustSummary_2.png)](screenshots/Posterior_CustSummary_2.png)
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CondEff_1.png")
```
[![](screenshots/Posterior_CondEff_1.png)](screenshots/Posterior_CondEff_1.png)
...
\
```{r echo = FALSE, results = "hide"}
knitr::include_graphics("screenshots/Posterior_CondEff_2.png")
```
[![](screenshots/Posterior_CondEff_2.png)](screenshots/Posterior_CondEff_2.png)
