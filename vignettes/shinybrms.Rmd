...
**NOTE:** The screenshots below were created using **shinybrms** version 1.5.1. However, version 1.5.2 has only introduced very few UI changes (see the [changelog](../news/index.html) for details).
